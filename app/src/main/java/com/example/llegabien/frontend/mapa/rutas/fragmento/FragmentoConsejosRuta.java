...
public class FragmentoConsejosRuta extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i < mRutaMasSegura.getDelitosZonasInseguras().size() + 1; i++) {
            if (i == mRutaMasSegura.getDelitosZonasInseguras().size())
                crearVistaConsejosRuta("GENERAL");
            else {
                if (mRutaMasSegura.getDelitosZonasInseguras().get(i).equals("ROBO")
                        || mRutaMasSegura.getDelitosZonasInseguras().get(i).equals("SECUESTRO")
                        || mRutaMasSegura.getDelitosZonasInseguras().get(i).equals("ACOSO SEXUAL")
                        || mRutaMasSegura.getDelitosZonasInseguras().get(i).equals("ABUSO SEXUAL")
                        || mRutaMasSegura.getDelitosZonasInseguras().get(i).equals("TIROTEO"))

                    crearVistaConsejosRuta(mRutaMasSegura.getDelitosZonasInseguras().get(i));
            }
        }
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void crearVistaConsejosRuta(String tipoDelito) {
        String delito;
        ...
        txtViewNombreDelito.setText(tipoDelito);
        ...
        setConsejos(tipoDelito, txtViewConsejos);
